...
#SBATCH --gres=gpu:1
#SBATCH --mem=16g
#SBATCH --job-name=whisper_profiling_medium
#SBATCH --error=error/whisper/whisper_error_medium.txt
#SBATCH --output=output/whisper/whisper_profiling_medium.txt
...
model_configs=("config/model_config/whisper/whisper_medium.yaml")
