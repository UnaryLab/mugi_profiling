...
#SBATCH --gres=gpu:2
#SBATCH --mem=64g
#SBATCH --job-name=whisper_e2e
#SBATCH --error=output/e2e/whisper/error.txt
#SBATCH --output=output/e2e/whisper/output.txt
...
nonlinear_config="config/nonlinear_config/nonlinear_e2e_config.yaml"
parameter_config="config/parameter_config/end_to_end_config.yaml"
hf_token="${TOKEN}"
