...
#SBATCH --gres=gpu:2
#SBATCH --mem=64g
#SBATCH --job-name=llama_2_13b_split_0
#SBATCH --error=output/profiling/llama_2_13b_split_0/error.txt
#SBATCH --output=output/profiling/llama_2_13b_split_0/output.txt
