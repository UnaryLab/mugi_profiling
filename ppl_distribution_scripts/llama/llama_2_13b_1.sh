...
#SBATCH --gres=gpu:2
#SBATCH --mem=64g
#SBATCH --job-name=llama_2_13b_split_1
#SBATCH --error=output/profiling/llama_2_13b_split_1/error.txt
#SBATCH --output=output/profiling/llama_2_13b_split_1/output.txt
