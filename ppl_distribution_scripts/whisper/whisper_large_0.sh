...
#SBATCH --gres=gpu:2
#SBATCH --mem=64g
#SBATCH --job-name=whisper_large_split_0
#SBATCH --error=output/profiling/whisper_large_split_0/error.txt
#SBATCH --output=output/profiling/whisper_large_split_0/output.txt
