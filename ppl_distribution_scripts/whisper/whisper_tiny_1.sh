...
#SBATCH --gres=gpu:2
#SBATCH --mem=64g
#SBATCH --job-name=whisper_tiny_split_1
#SBATCH --error=output/profiling/whisper_tiny_split_1/error.txt
#SBATCH --output=output/profiling/whisper_tiny_split_1/output.txt
