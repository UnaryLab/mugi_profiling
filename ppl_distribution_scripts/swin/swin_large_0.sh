...
#SBATCH --gres=gpu:2
#SBATCH --mem=64g
#SBATCH --job-name=swin_large_split_0
#SBATCH --error=output/profiling/swin_large_split_0/error.txt
#SBATCH --output=output/profiling/swin_large_split_0/output.txt
