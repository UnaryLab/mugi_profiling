...
#SBATCH --gres=gpu:2
#SBATCH --mem=64g
#SBATCH --job-name=swin_large_split_1
#SBATCH --error=output/profiling/swin_large_split_1/error.txt
#SBATCH --output=output/profiling/swin_large_split_1/output.txt
...
model_configs=("config/model_config/swin/swinv2_large.yaml")
nonlinear_config="config/nonlinear_config/nonlinear_config_split_1.yaml"
