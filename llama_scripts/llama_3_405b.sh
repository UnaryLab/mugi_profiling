...
#SBATCH --gres=gpu:8
#SBATCH --mem=128g
#SBATCH --job-name=llama_3_405b_profiling
#SBATCH --error=error/llama_3/llama_3_405b_error.txt
#SBATCH --output=output/llama_3/llama_3_405b_output.txt
...
model_configs=("config/model_config/llama/llama_3_405b.yaml")
#nonlinear_config="config/nonlinear_config/large_model_configs/nonlinear_config_torch.yaml"
nonlinear_config="config/nonlinear_config/large_model_configs/vlp_softmax_1.yaml"
