...
#SBATCH --error=output/llama_3_8b_error.txt
#SBATCH --output=output/llama_3_8b_output.txt
...
nonlinear_config="config/nonlinear_config/large_model_configs/nonlinear_config_vlp_attention.yaml"
