...
#SBATCH --error=output/run/swin/swin_large/error.txt
#SBATCH --output=output/run/swin/swin_large/output.txt
...
model_config="config/model_config/swin/swinv2_large.yaml"
