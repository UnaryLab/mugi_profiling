...
#SBATCH --gres=gpu:1
#SBATCH --mem=16g
#SBATCH --job-name=swinv2_profiling_base
#SBATCH --error=error/swin/swinv2_error_base.txt
#SBATCH --output=output/swin/swinv2_profiling_base.txt
...
model_configs=("config/model_config/swin/swinv2_base.yaml")
