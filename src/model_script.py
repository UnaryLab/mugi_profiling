...
def evaluate_model(model_dict, nonlinear_dict, parameter_dict, nonlinear_config_path):
    ...
    inference_model.csv_file = os.path.normpath(f'output/csv/{inference_model.model_name}/{nonlinear_config_path}/{inference_model.patched_layer_path}metric.csv'.lower())
